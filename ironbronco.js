...
const addUser = (ev)=>{
    ...
    let user = {
        ...
        team: null //set team when join team or create team
    }
    users.push(user);
...
//remove teamName because will be stored in the user data object
...
var userSwimData= {usercompleted: 0}; //need to display the data stored instead of 0
var userRunData= {usercompleted: 0};
var userBikeData= {usercompleted: 0};
displayObject("userswim", swimData);
displayObject("userrun", runData);
displayObject("userbike", bikeData);

var teamSwimData= {teamcompleted: 0}; //need to display the data stored instead of 0
var teamRunData= {teamcompleted: 0};
var temBikeData= {teamcompleted: 0};
displayObject("teamswim", swimData);
displayObject("teamrun", runData);
displayObject("teambike", bikeData);


*/

//Need to work on log-in page code
/*login page code
