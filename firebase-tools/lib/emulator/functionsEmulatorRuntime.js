    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield new Promise((resolveEphemeralServer, rejectEphemeralServer) => {
            ...
            const instance = ephemeralServer.listen(socketPath, () => {
                new types_1.EmulatorLog("SYSTEM", "runtime-status", "ready", { state: "ready", socketPath }).log();
            });
        });
    });
}
function processBackground(frb, trigger) {
    return __awaiter(this, void 0, void 0, function* () {
        const service = trigger.definition.eventTrigger
            ...
            : "unknown";
        new types_1.EmulatorLog("SYSTEM", "runtime-status", "ready", { state: "ready", service }).log();
...
function handleMessage(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!triggers) {
            triggers = yield initializeRuntime(runtimeArgs.frb, runtimeArgs.serializedTriggers);
        }
        if (!triggers) {
            yield flushAndExit(1);
            return;
