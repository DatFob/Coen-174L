...
class FunctionsEmulatorShell {
    ...
    call(name, data, opts) {
        ...
        functionsEmulator_1.FunctionsEmulator.startFunctionRuntime(this.emu.getBaseBundle(), name, functionsEmulatorShared_1.EmulatedTriggerType.BACKGROUND, this.emu.nodeBinary, proto);
    }
    getTrigger(name) {
